...
let main argv =
    ...
    let lowerBound = 197487
    let upperBound = 673251
    let nViablePasswords = countViablePasswords lowerBound upperBound
    // Day 4 - part 2 \\
    printfn "Day 4 - part 1: The amount of viable passwords between %d and %d is %d" lowerBound upperBound nViablePasswords
    // Day 4 - part 1 \\
    printfn "Day 4 - part 1: The amount of viable passwords between %d and %d is 1640" lowerBound upperBound
