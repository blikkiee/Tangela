...
let main argv =
    ...
    // Day 2 - part 1 \\
    printfn "Day 2 - part 1: After running the program '%d' is on 'address 0'." (List.item 0 result.Value) // 3716250
